  ...
  return (
    ...
    >
      ...
      >
        ...
        {!confirmationSent && <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          <div>
            <label
              htmlFor="email"
        ...
        {confirmationSent && (
          <div style={{ textAlign: 'center' }}>
            <h3 style={{ fontFamily: "'Inter', sans-serif", fontSize: '1.3rem', fontWeight: 500, color: 'var(--text-primary)', marginBottom: '0.75rem' }}>
              {t(language, 'auth.confirmationSent')}
            </h3>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', color: 'var(--text-secondary)', lineHeight: '1.6', marginBottom: '2rem' }}>
